...
#            classifier.
    ...
    def handle_expiration_callback(self, addr, entry):
        ...
        self.rule.remove_rule(match(srcip=IPAddr(addr))|match(dstip=IPAddr(addr)))
    ...
    def handle_classification_callback(self, addr, entry):
        ...
        self.rule.add_rule(match(srcip=IPAddr(addr))|match(dstip=IPAddr(addr)))
